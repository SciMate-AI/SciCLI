...
func (m InitDialogCmp) View() string {
	...
	explanation := baseStyle.
		...
		Width(maxWidth).
		Padding(0, 1).
		Render("Initialization generates a new SCICLI.md file that contains information about your codebase. It serves as project memory for coding agents, and you can extend it with any repository-specific guidance.")
